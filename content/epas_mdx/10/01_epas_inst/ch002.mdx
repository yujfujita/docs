...
this guide you will find detailed information about:
  ...
  - Installation options available through the interactive setup wizard
  ...
  - Using pg\_upgrade to upgrade from an earlier version of Advanced
    Server to Advanced Server 10.

  - Uninstalling Advanced Server and its components.

<div id="typographical-conventions-used-in-this-guide" class="section level2" data-number="1.1">
...
term’s exact meaning depends upon the context in which it is used.
  ...
  - Square brackets \[ \] denote that one or none of the enclosed terms
  ...
  - Braces {} denote that exactly one of the enclosed alternatives must
    be specified. For example, { a | b } means exactly one of “a” or “b”
    must be specified.

  - Ellipses ... denote that the preceding term may be repeated. For
